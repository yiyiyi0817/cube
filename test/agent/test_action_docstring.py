...
def test_transfer_to_openai_function():
    ...
    ACTION_FUNCS: List[OpenAIFunction] = [
        OpenAIFunction(func) for func in [
            TwitterAction.sign_up,
            TwitterAction.refresh,
            TwitterAction.create_tweet,
            TwitterAction.like,
            TwitterAction.unlike,
            TwitterAction.dislike,
            TwitterAction.undo_dislike,
            TwitterAction.search_tweets,
            TwitterAction.search_user,
            TwitterAction.follow,
            TwitterAction.unfollow,
            TwitterAction.mute,
            TwitterAction.unmute,
            TwitterAction.trend,
