...
def test_user_operations():
    ...
    cursor.execute(
        ...
        ('testuser', 'Test User', 'This is a test user', '2024-04-21 22:02:42',
         0, 0))
    conn.commit()
    ...
    assert user[3] == 'This is a test user'
    assert user[4] == '2024-04-21 22:02:42'
    assert user[5] == 0
    assert user[6] == 0
